...
import { Bot, TestTube2, CheckCircle, AlertCircle, Loader, MessageSquare, Clapperboard } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-8 bg-background font-body">
      <Card className="w-full max-w-3xl mx-auto shadow-2xl rounded-2xl overflow-hidden">
        ...
        <CardContent className="p-6 space-y-6 text-center">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 border-t pt-6">
                ...
                <div className="flex flex-col items-center gap-2">
                    ...
                    <Button asChild variant="outline">
                        <Link href="/anime">
                            <Clapperboard className="mr-2" /> Open Anime Downloader
                        </Link>
                    </Button>
                </div>
            </div>
